...
job_requirements,job_requirements_optional,job_project_management_system,job_what_to_offer,job_sportcard,job_healthplan,job_lifeinsurance) VALUES 
("Analityk SAS", "12000", "15000", "netto (+ VAT) mies.", "Praca w stabilnej firmie, która od 12 lat stale obsługuje T-Mobile i Orange, a obecnie także szybko rozwija świadczenie usług dla innych klientów na rynku krajowym i międzynarodowym", 
"Warszawa", "2023-01-01", "2024-06-01", "umowa zlecenie, kontrakt B2B","Cały etat","specjalista (Mid / Regular)","praca hybrydowa","rekrutacja zdalna","<ul><li>SQL</li><li>NOSQL</li><li>Konteneryzacja</li></ul>","<ul><li>ORACLE</li><li>Git</li><li>Java</li></ul>","<ul><li>Linux</li></ul>","<ul><li>Administracja i utrzymanie systemów OSS </li><li>Instalacja i utrzymanie środowisk opartych o systemy: Linux, bazy danych typu Sql i NoSql</li></ul>",
"<ul><li>SQL</li><li>SAS</li><li>Oracle</li></ul>","<ul><li>SQL</li><li></li><li></li></ul>","<ul><li>Doświadczenie w administracji relacyjnych baz danych jak Oracle, MySQL</li></ul>",
