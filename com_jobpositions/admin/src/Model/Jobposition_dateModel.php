...
class Jobposition_dateModel extends AdminModel
{
	/**
	...
	public function publish(&$pks, $value = 1) {
		...
		$query->update($db->quoteName('#__jobposition_dates'))
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jobpositions.jobposition_date', 'jobposition_date', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jobpositions.edit.jobposition_date.data', array());
		...
		$this->preprocessData('com_jobpositions.jobposition_date', $data);
