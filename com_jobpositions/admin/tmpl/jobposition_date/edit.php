...
$walk_id = $app->getUserState('com_jobpositions.walk_id');
...
<form action="<?php echo Route::_('index.php?option=com_jobpositions&view=jobposition_date&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="jobposition-dates-form" class="form-validate">
