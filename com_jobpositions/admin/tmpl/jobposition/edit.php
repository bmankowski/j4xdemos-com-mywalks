...
<form action="<?php echo Route::_('index.php?option=com_jobpositions&view=jobposition&layout=edit&id=' . (int) $this->item->id); ?>"
      method="post" name="adminForm" id="jobpositions-form" class="form-validate">
    ...
    <div>
        ...
        <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'options', Text::_('COM_JOBPOSITIONS_JOBPOSITION_TAB_JOBDETAILS')); ?>
        <div class="row">
            <div class="col-md-12">
