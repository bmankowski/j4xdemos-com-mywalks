...
use itconnect\Component\Jobpositions\Administrator\Helper\JobpositionsHelper;
					...
					<table class="table" id="jobpositionsList">
						...
						foreach ($this->items as $i => $item) :
							...
							<tr class="row<?php echo $i % 2; ?>">
								...
								<td>
									<a href="index.php?option=com_jobpositions&task=jobposition_date.edit&id=<?php echo $item->id; ?>">
